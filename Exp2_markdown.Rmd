...
load("Exp2_gamm_workspace.RData")
```
...
Ball stimulus
```{r}
png("graphics/plot_reversed_videos_exp2_m4_summed_effect_ball.png", width=16, height=12, units="cm", res=600)
...
Fur ball:
```{r}
png("graphics/plot_reversed_videos_exp2_m4_summed_effect_fur.png", width=16, height=12, units="cm", res=600)
